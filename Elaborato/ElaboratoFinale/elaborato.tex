...
assicurato, in grado di registrare tutti gli spostamenti di un'automobile, nonchè\todo{AT: fai uno spellcheck, accenti sbagliati} il
...
\cite{fracassi2012}.\todo{AT: accennare già al fatto della profilazione?}
...
\begin{itemize}
    ...
    \item \textbf{Recupero dei veicoli rubati}: la localizzazione GPS permette di tracciare e recuperare rapidamente veicoli rubati.\todo{AT: se non lo rimuovono/staccano}
...
Il monitoraggio consiste nella raccolta dati di alcuni parametri provenienti dal lettore OBD\todo{AT: la prima volta che usi un termine non di uso comune devi spiegarlo o mettere un rimando (anche in avanti) alla spiegazione} e da alcuni sensori installati sulla black-box. 
...
\end{figure}\todo{AT: i diarammi di flusso sanno di ``antico'', li ridurrei in dimensione o eliminerei}
...
\todo{AT: avrei messo (anche o solo) uno schema ER}
