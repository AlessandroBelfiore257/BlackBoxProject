...
\begin{table}[h!]
  ...
  \begin{adjustbox}{max width=\textwidth}
    \begin{tabular}{|c|c|c|c|c|c|c|c|}
      ...
      \hline
      Brusco & $[4,9] \ \text{m/s}^2$ & $[4,9] \ \text{m/s}^2$ & $[4000,8000] \ \text{giri/min}$ & $[110,220] \ \text{km/h}$ & $[50,100] \%$ & $[40,100] \%$  & 0.73\\
      \hline
      Intermedio & $[0,9] \ \text{m/s}^2$ & $[0,9] \ \text{m/s}^2$ & $[750,8000] \ \text{giri/min}$ & $[0,220] \ \text{km/h}$ & $[0,100] \%$ & $[0,100] \%$  & 0.66\\
      \hline
      Moderato & $[0,4] \ \text{m/s}^2$ & $[0,4] \ \text{m/s}^2$ & $[750,4000] \ \text{giri/min}$ & $[0,110] \ \text{km/h}$ & $[20,70] \%$ & $[10,50] \%$  & 0.40\\
      \hline
    \end{tabular}
  \end{adjustbox}
...
Giunto alla conclusione di questo percorso, mi rendo conto che il percorso universitario non è stato solo una crescita personale e accademica, ma anche un percorso arricchito dalla presenza di persone che hanno contribuito a rendere questa esperienza unica.
Vorrei ringraziare profondamente la mia famiglia, per il loro supporto incondizionato, l'incoraggiamento costante e la fiducia che hanno sempre riposto in me. I vostri sacrifici, la vostra pazienza e il vostro amore mi hanno dato la forza di superare ogni difficoltà e raggiungere questo importante traguardo.
Un grazie particolare va a mio fratello, che è stato un esempio di determinazione e impegno. Il suo sostegno e la sua capacità di farmi vedere il lato positivo anche nei momenti più difficili hanno fatto la differenza in molte occasioni.
