...
/*
  Restituisce il numero di 1 presenti all'interno di un array
*/
...
void updateRedAllarm() {
  ...
  storeRedProblem(nRilevamentiTempEngine, "Liquido raffreddamento", dateTimeStr, "Temperatura", "raffreddamento alta");
  storeRedProblem(nRilevamentiTempOil, "Olio motore", dateTimeStr, "Temperatura olio", "motore alta");
  storeRedProblem(nRilevamentiCoppiaEngine, "Coppia motore", dateTimeStr, "Malfunzionamento", "coppia motore");
