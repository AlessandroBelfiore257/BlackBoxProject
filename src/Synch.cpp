...
/*
  Funzione che dato un db e un record ne aggiorna il campo syncronised 
*/
...
/*
  Funzione che manda i dati di monitoraggio al server
*/
...
// ########################################### Profilazione ###########################################
/*
  Funzione per ottenere i record non sincronizzati dalla tabella t3 (profilazione), ordinati per lastStorage crescente
*/
...
/*
  Funzione che manda i dati di profilazione al server
*/
...
/*
  Funzione per ottenere i record non sincronizzati dalla tabella t4
*/
...
/*
  Funzione che manda i dati relativi agli allarmi più critici al server
*/
...
/*
  Funzione per ottenere i record non sincronizzati dalla tabella t5
*/
...
/*
  Funzione per aggiornare lo stato di sincronizzazione nella tabella t5
*/
...
/*
  Funzione che manda i dati relativi agli allarmi meno critici al server
*/
