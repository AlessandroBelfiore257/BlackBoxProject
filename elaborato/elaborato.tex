...
Il principale vantaggio del tracking dei veicoli è che, grazie al localizzatore GPS, risulta utile in caso di furto, facilitando il rintracciamento del veicolo. Naturalmente, il localizzatore gioca un ruolo importante anche nella gestione degli incidenti, come verrà discusso nel prossimo paragrafo.
...
Nella figura seguente è riportato un esempio di implementazione di una parte dell'algoritmo di profilazione conducente, utilizzato per catturare gli eventi più critici che conducono alla valutazione di una guida spericolata. Questo frammento di codice illustra come vengono registrate le situazioni riconducibili ad una guida poco prudente; inoltre verso la fine del task, precisamente a riga 32, viene fatta una valutazione riguardante il numero di campionamenti fatti sino a quel momento, se il numero di campionamenti risulta essere soddisfacente, allora si può procedere alla valutazione del conducente:
